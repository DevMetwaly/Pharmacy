...
$rest=$db->Fetch("SELECT COUNT(*) as ReStock FROM proudcts WHERE Quantity <= 5",false);
...
$result["information"][0]=$ncust;
$result["information"][1]=$ninv;
$result["information"][2]=$expi;
$result["information"][3]=$rest;
